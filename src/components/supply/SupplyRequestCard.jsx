        ...
        <div className="grid grid-cols-[auto_auto_minmax(0,1.5fr)_minmax(0,1fr)_auto_auto_auto_auto_auto] items-center gap-3 p-2">
          ...
          <div className="flex items-center justify-end gap-2">
            {(() => {
              ...
              const total = linkedOrders
                ? linkedOrders.reduce((s, o) => s + (request.orderAmounts?.[o.orderId] || 0), 0)
                : Object.values(request.orderAmounts || {}).reduce((s, v) => s + (v || 0), 0);
              return total > 0 ? (
            ...
            {request.leadTime && LEAD_TIME_TYPES[request.leadTime] && (() => {
              ...
              const label = request.leadTime === 'custom' && request.leadTimeCustomDays
