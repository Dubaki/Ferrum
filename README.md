...
| Роль | Ключ | Пароль | Доступ |
|------|------|--------|--------|
| Технолог | `technologist` | `fer25` | Планирование, отгрузка, снабжение (создание, согласование), цех, Ганта |
| Снабженец | `supplier` | `fer25` | Снабжение (счета, доставка) |
| Начальник цеха | `shopManager` | `proplex` | Всё (администратор) |
| Директор | `director` | `proplex` | Всё (администратор) |
| Веста | `vesta` | `LG26` | Снабжение (полный доступ), цех |
| Мастер | `master` | `fer25` | Планирование, отгрузка, снабжение, Ганта, режим цеха |
